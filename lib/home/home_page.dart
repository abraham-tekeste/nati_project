...
final categoriesIndexProvider = StateProvider((ref) => 0);
...
class CategoriesWidget extends ConsumerWidget {
  ...
  Widget build(BuildContext context, ref) {
    ...
    final selectedIndex = ref.watch(categoriesIndexProvider);
          ...
          child: ListView.builder(
              ...
              itemBuilder: (context, index) => GestureDetector(
                    onTap: () {
                      ...
                      ref.read(categoriesIndexProvider.notifier).state = index;
                    ...
                    child: Container(
                      ...
                      decoration: BoxDecoration(
                        color: index ==
                                ref.read(categoriesIndexProvider.notifier).state
                            ? Colors.black
                            : tdBGColor,
    ...
    return Card(
      ...
      child: Column(
        children: [
          ...
          //   height: 61,
          //   decoration: BoxDecoration(
          //     image: DecorationImage(image: AssetImage(product.images.first)),
          //   ),
          //   // child: Padding(
